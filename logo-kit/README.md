...
Готовые «заготовки» работы с логотипом. Один PNG (белое лого на чёрном фоне) превращается в красивый, перекрашиваемый и анимированный элемент **только средствами CSS**, без правки самой картинки.
